...
4. Implement the session-user endpoint SessionUser.java.  The particulars of the implementation will be determined by the session/user authentication mechanisms your application uses.  See comments and sample output in file SessionUser.java (src/com/cc30/sessionuser).

...
var myFunFactory = {
    ...
    PDFURL: "/coolcalc/client/api2pdf",

    // The URL we use to email a PDF to a user.
    emailURL: "/coolcalc/client/emailreport",
    ...
    localResourceTemplateURL: "/coolcalc/LocalTemplates",
...
// The "MJ8Preview" REST resource is a custom resource we create locally, not part of the CoolCalc API proper.
